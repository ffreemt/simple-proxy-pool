...
import aiohttp
from aiosocksy.connector import ProxyConnector, ProxyClientRequest  # modi

# from proxybroker.errors import BadStatusError
# from proxybroker.utils import IPPattern, IPPortPatternGlobal, get_headers, log
...
class Provider:
    ...
    async def get_proxies(self):
        ...
        # LOGGER.debug('Try to get proxies from %s' % self.domain)
